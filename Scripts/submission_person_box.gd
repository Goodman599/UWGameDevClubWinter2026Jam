extends Node2D
class_name SubmissionPersonBox

@export var max_cards: int = 3
@export var target_text_node: RichTextLabel
@export var accepted_card_type: String = "Person"
...
signal card_added(card: Control, box: SubmissionPersonBox)
signal card_removed(card: Control, box: SubmissionPersonBox)
signal submission_ready(cards: Array)
signal wrong_card_type(card: Control, box: SubmissionPersonBox)
